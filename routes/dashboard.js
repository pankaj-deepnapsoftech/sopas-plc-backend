...
router.post('/plc-machine-data', require('../controllers/dashboard').createPlcMachineData);
router.get('/plc-machine-data', require('../controllers/dashboard').getPlcMachineData);
